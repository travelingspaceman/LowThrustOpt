...
#
#A fast, capable Lambert's problem solver.
#Julia adaptation by Nathan Parrish, adapted from MATLAB code by Dario Izzo.

function lambert(r1,r2,t,mu_C,lw,N,branch)
  #
  ...
  if N==0
      ...
      err=1;
      i=0;
      xnew = 0. #temporary value (to elevate scope)
      while ((err>tol) && !(y1==y2))
          i=i+1;
...
function tofabn(sigma,alfa,beta,N)
